    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h3><i class="fas fa-edit"></i> Modifier l'Horaire #{{ $schedule->id }}</h3>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('admin.schedules.update', $schedule) }}">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" id="seats_available" name="seats_available"
                                   value="{{ old('seats_available', $schedule->seats_available) }}" required>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save"></i> Modifier l'horaire
                        </button>
                    </div>
                </form>
            </div>
